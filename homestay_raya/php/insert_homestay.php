...
$image2 = $_POST['image2'];
$image3 = $_POST['image3'];
$sqlinsert = "INSERT INTO homestay(Name,Username,Address,Pax,Facilities,Price,State,Locality,Latitude,Longitude)
VALUES('$name','$username','$address','$pax','$facility','$price','$state','$local','$lat','$lon')";
